...
title = '''
    ...
    _|    \__, |____/ ____/ \___/ ____/ _____/ \___|_|   _| .__/ \__|  
           ____/                                            _|         
   DDos python 脚本 | 用于测试ddos的脚本| ddos攻击    
 Author: T7hM1                                                
...
'''
	...
	options.add_argument('-d',metavar='<ip|domain>',default=False,help='指定您的目标，例如 ip 或域名')
	options.add_argument('-t',metavar='<float>',default=5.0,help='接口超时')
	options.add_argument('-T',metavar='<int>',default=1000,help='设置连接的线程数 (default = 1000)')
	...
	options.add_argument('-i',metavar='<ip address>',default=False,help='除非使用假ip，否则请指定假冒ip')
	options.add_argument('-Request',action='store_true',help='设置 request 攻击')
	options.add_argument('-Synflood',action='store_true',help='设置 synflood 攻击')
	options.add_argument('-Pyslow',action='store_true',help='设置 pyslow 攻击')
